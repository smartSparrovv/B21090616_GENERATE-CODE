...
data_table = pd.read_csv(f"../_2_DataProgress/datas/tables/table_30Hz.csv")
data_type = ['B30', 'M30', 'N30', 'R30']
type_index = 0
...
for type_name in data_type:
    ...
    for image_num in range(2400):  # 对每一个状态制作样本的个数
        ...
        jpg_filename = f"./LEN1792_WT/30Hz/{type_name}/{type_name}_{image_num + 1}.jpg"
