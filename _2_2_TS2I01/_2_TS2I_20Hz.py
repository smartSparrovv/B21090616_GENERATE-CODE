...
data_table = pd.read_csv(f"../_2_DataProgress/datas/tables/table_20Hz.csv")
data_type = ['B20', 'M20', 'N20', 'R20']
type_index = 0
...
for type_name in data_type:
    ...
    for image_num in range(2400):  # 对每一个状态制作样本的个数
        ...
        jpg_filename = f"./LEN1792_WT/20Hz/{type_name}/{type_name}_{image_num + 1}.jpg"
